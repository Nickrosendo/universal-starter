...
@Component({
  moduleId: module.id,
  selector: 'octadesk-contact-form',
...
export class ContactFormComponent implements OnInit {
  ...
  //
  validateMessage(elem) {
    if (elem.target.checkValidity()) {
      this.hasDanger.message = false;
      this.hasSuccess.message = true;
    } else {
      this.hasSuccess.message = false;
      this.hasDanger.message = true;
    }
  }
