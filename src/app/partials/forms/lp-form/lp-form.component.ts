...
export class LpFormComponent implements OnInit {
  ...
  departamentoOptions: Array<KeyValue> = [
	...
	totalEmployeesOptions: Array<KeyValue> = [
		...
		{ value: '1 a 5', label: 'de 1 a 5', disabled: false },
		{ value: '6 a 10', label: 'de 6 a 10', disabled: false },
		{ value: '11 a 30', label: 'de 11 a 30', disabled: false },
    { value: '31 a 50', label: 'de 31 a 50', disabled: false },
    { value: '51 a 100', label: 'de 51 a 100', disabled: false },
    { value: '101 a 250', label: 'de 101 a 250', disabled: false },
    { value: '251 a 500', label: 'de 251 a 500', disabled: false },
    { value: '500 a 1000', label: 'de 500 a 1000', disabled: false },
		{ value: 'acima de 1001', label: 'acima de 1001', disabled: false }
  ];
  ...
  resetForm() {
	...
	onSubmit(event: Event) {
      ...
      .subscribe(response => {
        ...
        return _this.onSubmitted.emit(response.status === 200);
      });
