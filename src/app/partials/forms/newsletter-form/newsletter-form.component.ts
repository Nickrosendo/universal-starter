...
@Component({
	moduleId: module.id,
	selector: 'octadesk-newsletter-form',
	templateUrl: './newsletter-form.component.html'
})
export class NewslettertFormComponent implements OnInit {
	...
	ngOnInit() {
		this.form = this.formBuilder.group({
			...
			identificador: 'site-newsletter' // this.RdIdentificator
		});
	}
	...
	onSubmit(event: Event) {
		...
		if (this.form.valid && this.valid()) {
			...
			// 							elementId: this.GtmFormIdentificator
			// 						},
	...
	validateFreeDomainsList(value) {
		...
		this.freeDomainsList().forEach(function (domain) {
