...
@Component({
  selector: 'app-ad-sistema-atendimento-onlineb',
  templateUrl: './ad-sistema-atendimento-onlineb.component.html',
  providers: [ LinkService ]
})
export class AdSistemaAtendimentoOnlinebComponent implements OnInit {
  ...
  linkService.addTag( { rel: 'canonical', href: 'https://www.octadesk.com/sistema-atendimento-online-adb' } ) }
